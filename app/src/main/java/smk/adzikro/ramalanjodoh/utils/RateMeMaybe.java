...
public class RateMeMaybe implements RateMeMaybeFragment.RMMFragInterface {
    ...
    public String getDialogMessage() {
        if (mDialogMessage == null) {
            return "Jika kamu suka "
                    + this.getApplicationName()
                    + ", dan ini sangat bagus "
                    + " mohon rate aplikasi ini di play store ";
        } else {
    ...
    public void run() {
        ...
        if (!isPlayStoreInstalled()) {
            Log.d(TAG, "Play Store tidak terinstall di device ini");
    ...
    public void _handlePositiveChoice() {
        ...
        try {
            ...
            Toast.makeText(mActivity, "tidak bisa menjalankan Play Store!",
